...
export class Enemy extends Entity {
    ...
    public hpBar!: THREE.Mesh // Thanh máu thực tế
    private hpBarContainer!: THREE.Group // Chứa cả thanh nền và thanh máu

    private billboardCamera: THREE.Camera | null = null

    constructor(mesh: THREE.Mesh, maxHp = 100, radius = 0.75) {
    ...
    setBillboardCamera(camera: THREE.Camera | null) {
    ...
    update(dt: number) {
        if (this.isDead) return
        super.update(dt)
        // Luôn quay mặt về phía Camera để người chơi luôn nhìn rõ thanh máu
